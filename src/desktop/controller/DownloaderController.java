...
import desktop.base.YoutubeSong;
...
import static desktop.util.FxCache.conf;
...
public class DownloaderController extends Controller {
    ...
    private HashMap<String, String> parseOptions(){
        ...
        options.put("ffmpeg-location", conf.getCurrentPath() + File.separator + conf.getValue("ffmpeg_path"));
